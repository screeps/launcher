...
/**
 * Placeholder function for creating proxy sockets. This method immediately returns
 * without a socket
 *
...
SMTPPool.prototype._createConnection = function () {
    ...
    connection.once('error', function (err) {
        if (err.code !== 'EMAXLIMIT') {
            ...
            this.logger.debug('Max messages limit exhausted for #%s', connection.id);
        }
        ...
        // remove the erroneous connection from connections list
